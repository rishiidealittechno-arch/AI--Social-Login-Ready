...
export default function InputChat({ onSend, disabled = false }: InputChatProps) {
    ...
    return (
        <motion.form
            ...
            <InputGroup className="bg-white h-auto flex-col ring-0 border-none has-[[data-slot=input-group-control]:focus-visible]:ring-0 overflow-hidden rounded shadow-sm">
                <InputGroupTextarea
                className="focus-visible:ring-0 ring-0 border-none"
                    value={message}
